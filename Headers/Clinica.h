...
class Clinica{
    ...
    private:
        ...
        std::vector<std::unique_ptr<Paciente>> pacientes_desativados; //Vector que contém todos pacientes que foram desligados da clinica
        std::vector<std::unique_ptr<Medico>> medicos_desativados; //Vector que contém todos médicos que foram desligados da clinica
        std::vector<std::unique_ptr<Servico>> servicos_desativados; ////Vector que contém todos serviços que foram desligados da clinica
